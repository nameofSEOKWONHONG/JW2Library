...
namespace JWLibrary.Database
{
    public static class RedisExtension
    {
        ...
        {
            if (typeof(T).IsValueType || typeof(T) == typeof(string)) return db.StringSet(key, obj.xSafe());
        ...
        {
            if (typeof(T).IsValueType || typeof(T) == typeof(string)) return db.StringGet(key).xSafe<T>();
