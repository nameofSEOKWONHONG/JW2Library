...
namespace JWLibrary.Database {
    ...
    public class JDbClientExecutor : IDisposable {
        ...
        public void SetCache<TKey, TResult>(TKey key, TResult result) {
            JDataCacheHandler.Instance.GetOrAdd<TKey, TResult>(key, result, ENUM_CACHE_TYPE.ROCKSDB);
        }
        
        public void ResetCache<TKey>(TKey key) {
            JDataCacheHandler.Instance.ResetCache<TKey>(key, ENUM_CACHE_TYPE.ROCKSDB);
        }
