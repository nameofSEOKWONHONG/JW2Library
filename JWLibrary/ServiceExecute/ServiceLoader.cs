...
namespace JWLibrary.ServiceExecutor
{
    ...
    public static class ServiceLoader
    {
        ...
        public static void Load(this IServiceCollection services, IEnumerable<IServiceInjector> serviceRegisters)
        {
        ...
        public static void Load(this IServiceCollection services)
        {
            ...
            if (serviceRegisters.xIsNotEmpty())
                serviceRegisters.xForEach(svcRegister => { svcRegister.Register(services); });
        }
    }
}